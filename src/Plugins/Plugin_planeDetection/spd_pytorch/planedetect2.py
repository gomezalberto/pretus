...
def getprediction(image_cpp, move_threshold=True, verbose=False):
    global imnumber
    try:
        start = time.time()
        ...
        labels = getlabels()
        if verbose:
            print("planedetect2.py - getprediction: labels")
            print(labels)
        ...
        if verbose:
            print("planedetect2.py - getprediction: 9")
        #print(a.device)
        #print(device)
        # this is a problem in the workstation
        im_data = a.to(device)
        if verbose:
            print("planedetect2.py - getprediction: 10")
        ...
        print("::WARNING:: planedetect detected an exception")
